...
setwd(dir = "Clay")
setwd(dir = "qRT")
datadf <- data.frame(read.csv("Plate1053117MCF7CSCsMSHitsEMT_data.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
...
write.csv(cscDF, "Plate1053117MCF7CSCsMSHitsEMT.csv")
...
ggplot(plotcscDF) + 
  ...
  scale_fill_gradient(trans = 'log', breaks = c(1, 2, 5, 10, 20, 50, 100, 300, 500, 1000), low = "white", high = "royalblue", name = "") + 
  xlab("") + 
  ylab("") + 
