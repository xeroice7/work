...
negRFPdf <- data.frame(read.csv("Plate1060617MDARFPNoDoxSCAssay.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
posRFPdf <- data.frame(read.csv("Plate2060617MDARFP3d+DoxSCAssay.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
