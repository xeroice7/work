...
datadf <- data.frame(read.csv("Plate1060817MCF7sGRP78EMTMSHits_data.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
...
write.csv(cscDF, "Plate1060817MCF7sGRP78MSHitsEMT-Analyzed.csv")
