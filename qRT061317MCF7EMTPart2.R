...
datadf <- data.frame(read.csv("Plate1061317MCF7EMTPt2_data.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
...
csc <- as.data.frame(filter(datadf, Population == "CD24-/CD24+"))
...
write.csv(cscDF, "Plate1061317MCF7EMTPart2-Analyzed.csv")
