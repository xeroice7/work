...
datadf <- data.frame(read.csv("Plate2061617MCF7CSCMShitSEMT.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
...
write.csv(cscDF, "Plate1061617MCF7CSCMSHitsEMT-Analyzed.csv")
