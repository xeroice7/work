...
datadf <- data.frame(read.csv("Plate3061617MCF7sGRP78CSCEMTMShitsPt2.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
...
write.csv(cscDF, "Plate3061617MCF7sGRP78CSCEMTPart2-Analyzed.csv")
