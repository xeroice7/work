...
setwd(dir = "Clay")
setwd(dir = "qRT")
negGFPdf <- data.frame(read.csv("071816A549sGRP78-SCAssay.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
posGFPdf <- data.frame(read.csv("071816A549sGRP78+SCAssay.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
negRFPdf <- data.frame(read.csv("071816NCIsGRP78-SCAssay.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
posRFPdf <- data.frame(read.csv("071916NCIsGRP78+SCAssay.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE))
