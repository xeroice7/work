...
datadf <- data.frame(read.csv(paste(file.path, "Plate1072617HCCMCF7sGRP78MShitswNew_data.csv", sep=""), header = TRUE, sep = ",", stringsAsFactors = FALSE))
...
write.csv(cscDF, "Plate1072617MCF7sGRP78MSHits-Analyzed.csv")
